...
const ServicesSection: React.FC = () => {
  ...
  return (
    <section id="services" className="py-24 bg-gradient-to-br from-gray-800 via-gray-900 to-black relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          <div className="inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur-md rounded-full border border-white/20 shadow-xl mb-8">
            ...
            <span className="text-gray-300 font-medium">Services & Opportunities</span>
          </div>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative z-10 p-8">
                {/* Icon */}
                <div className="mb-6">
                  <div className={`w-20 h-20 bg-gradient-to-br ${service.gradient} rounded-3xl flex items-center justify-center shadow-2xl group-hover:scale-110 transition-transform duration-300 mb-4`}>
                    <span className="text-3xl">{service.icon}</span>
                  </div>
                  <h3 className="font-roboto font-bold text-2xl text-white mb-3 group-hover:text-blue-300 transition-colors duration-300">
                    {service.title}
                  </h3>
                </div>
        ...
        <div className="text-center bg-white/5 backdrop-blur-xl rounded-3xl p-12 border border-white/10">
          <h3 className="font-roboto font-bold text-3xl text-white mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="group px-8 py-4 bg-gradient-to-r from-blue-500 via-blue-600 to-cyan-500 text-white font-bold text-lg rounded-2xl shadow-2xl hover:shadow-blue-500/40 hover:scale-105 transition-all duration-500 relative overflow-hidden"
            >
            ...
            <button 
              ...
              className="group px-8 py-4 border-2 border-blue-400/50 bg-white/10 backdrop-blur-md text-blue-300 font-bold text-lg rounded-2xl hover:bg-blue-500/20 hover:border-blue-300 transition-all duration-500 hover:scale-105 shadow-lg hover:shadow-xl"
            >
